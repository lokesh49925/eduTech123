...
const coursesData = [
  ...
  },
  {
   id: 3,
    ...
    price: "₹999",
    desc: "Digital Marketing Essentials with SEO & SEM",
    duration: "4 Weeks",
    level: "Beginner",
    students: 450,
    rating: 4.5,
  ...
  return (
    <section className="course-section" id="course">
      <div className="choose-header">
        <h2 className="title sub-title">Start Your Learning Journey</h2>
        <p className="subtitle">
          Choose Trending online courses with new additions every
          month.
        </p>
      </div>
        ...
        {filteredCourses.map((course) => (
          <article className="course-card" key={course.id}>
            ...
            <div className="card-body">
              ...
              <a href={`/${course.name.toLowerCase().replace(/\s+/g, "-")}`}>
              <button className="join-btn">Explore Course</button>
              </a>
            </div>
          </article>
        ))}
